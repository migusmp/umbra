...
SRC := src/main.cpp src/core/window.cpp src/core/engine.cpp src/renderer/shader.cpp src/renderer/triangle.cpp src/renderer/camera.cpp vendor/glad/src/glad.c
